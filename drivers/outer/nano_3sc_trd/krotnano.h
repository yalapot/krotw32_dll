...
} T_GARY_ARC_THREAD_ARG;

extern int fileIndex;

extern unsigned __stdcall Thread_Gary_arc( void* pArguments );
...
extern long Gary_arc( T_OPENED_TRACE *P_trace, long spin_num, T_SPIN_INFO * spin_info);
extern void Smooth_spin(T_OPENED_TRACE *P_trace, T_SPIN_INFO * spin_info);
