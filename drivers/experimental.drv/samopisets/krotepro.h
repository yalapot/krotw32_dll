...
#define MAX_MEDIAN_FILTER_LENGTH 1024


#define MAX_DATA_MEDIAN 16384
...
#define lo_border_KEY                "lo_border"
...
extern long Init_NavData(T_NAVIGATION_DATA *NavData, char * trc);

extern long Init_VogData(T_VOG_DATA *VogData, char * trc);
