...
long WINAPI set_sens_sort_STRS_500 (T_OPENED_TRACE * opened_trace) {
 ...
 long tmp_val;
   ...
   for (i=168; i<336; i++) {
      if (flag_phase) {
          opened_trace->sens_shift[i] = 206;
       } else {
          opened_trace->sens_shift[i] = 196;
       };
      internal_cirkle_counter++;
      if (internal_cirkle_counter>=8) {
         flag_phase= (!flag_phase);
   ...
   for (i=0; i<672/16; i++) {
       for (j=0; j<8; j++) {
          ...
          tmp_val = opened_trace->sens_sort[res];
          opened_trace->sens_sort[res]  = opened_trace->sens_sort[res1];
          opened_trace->sens_sort[res1] = tmp_val;
...
//    };
   ...
   // меняем местами сектора 4 и 1
   for (i=0; i<128; i++) {
      opened_trace->sens_sort[384+i]=i;
      opened_trace->sens_sort[i]=384+i;
    };
...
//    };
   ...
   for (i=0; i<128; i++) {
      opened_trace->sens_shift[i] = 256;
      opened_trace->sens_shift[256+i] = 256;
    };
...
long set_sens_sort_cor_508 (T_OPENED_TRACE * opened_trace) {
 ...
 long flag_phase;
   ...
   // смещение во 2 поясе
   for (i = 0; i < 352; i++) {
      opened_trace->sens_shift[i] += 232; // смещение назад в измерениях
    };
...
long set_sens_sort_cor_426 (T_OPENED_TRACE * opened_trace) {
 long i;
   ...
   // смещение во 2 поясе
   for (i=0; i<256; i++) {
      opened_trace->sens_shift[i] = 415; // смещение назад в измерениях
    };

   // порядок датчиков во 2 поясе
//   for (i=0; i<128; i++) {
//      opened_trace->sens_sort[256+i] = 256+(127-i);
//    };
...
long set_sens_sort_prof_325 (T_OPENED_TRACE * opened_trace) {

   opened_trace->sens_sort[0 ]=0 ;
   opened_trace->sens_sort[1 ]=1 ;
   opened_trace->sens_sort[2 ]=2 ;
   opened_trace->sens_sort[3 ]=3 ;
   opened_trace->sens_sort[4 ]=4 ;
   opened_trace->sens_sort[5 ]=5 ;
   opened_trace->sens_sort[8 ]=6 ;
   opened_trace->sens_sort[9 ]=7 ;
   opened_trace->sens_sort[10]=8 ;
   opened_trace->sens_sort[11]=9 ;
   opened_trace->sens_sort[12]=10;
   opened_trace->sens_sort[13]=11;
   opened_trace->sens_sort[16]=13;
   opened_trace->sens_sort[17]=12;
   opened_trace->sens_sort[18]=14;
   opened_trace->sens_sort[19]=15;
   opened_trace->sens_sort[20]=16;
   opened_trace->sens_sort[21]=17;
   opened_trace->sens_sort[6 ]=18;
   opened_trace->sens_sort[7 ]=19;
   opened_trace->sens_sort[14]=20;
   opened_trace->sens_sort[15]=21;
   opened_trace->sens_sort[22]=22;
   opened_trace->sens_sort[23]=23;
   opened_trace->sens_sort[24]=24;
   opened_trace->sens_sort[25]=25;
   opened_trace->sens_sort[26]=26;
   opened_trace->sens_sort[27]=27;
   opened_trace->sens_sort[28]=28;
   opened_trace->sens_sort[29]=29;
   opened_trace->sens_sort[30]=30;
   opened_trace->sens_sort[31]=31;
   opened_trace->sens_sort[32]=32;
   opened_trace->sens_sort[33]=33;
   opened_trace->sens_sort[34]=34;
   opened_trace->sens_sort[35]=35;
   opened_trace->sens_sort[36]=36;
   opened_trace->sens_sort[37]=37;
   opened_trace->sens_sort[38]=38;
   opened_trace->sens_sort[39]=39;
   opened_trace->sens_sort[40]=40;
   opened_trace->sens_sort[41]=41;
   opened_trace->sens_sort[42]=42;
   opened_trace->sens_sort[43]=43;
   opened_trace->sens_sort[44]=44;
   opened_trace->sens_sort[45]=45;
   opened_trace->sens_sort[46]=46;
   opened_trace->sens_sort[47]=47;
   opened_trace->sens_sort[48]=48;
   opened_trace->sens_sort[49]=49;
   opened_trace->sens_sort[50]=50;
   opened_trace->sens_sort[51]=51;
   opened_trace->sens_sort[52]=52;
   opened_trace->sens_sort[53]=53;
   opened_trace->sens_sort[54]=54;
   opened_trace->sens_sort[55]=55;
   opened_trace->sens_sort[56]=56;
   opened_trace->sens_sort[57]=57;
   opened_trace->sens_sort[58]=58;
   opened_trace->sens_sort[59]=59;
   opened_trace->sens_sort[60]=60;
   opened_trace->sens_sort[61]=61;
   opened_trace->sens_sort[62]=62;
   opened_trace->sens_sort[63]=63;
...
// сортировка и смещение датчиков для профиля 700_2
long set_sens_sort_prof_700_2 (T_OPENED_TRACE * opened_trace) {
 long i, j;

   j=0;
   for (i=0; i<40; i++) {
      opened_trace->sens_sort[j]   = i;
      opened_trace->sens_sort[j+4] = i+40;
      j++;
      if (j%4 == 0) j+=4;
    };
...
long set_sens_sort_prof_500_2(T_OPENED_TRACE * opened_trace) {
  ...
  int i, j, jamp;
      ...
      jamp = 0;
      for (i=0; i<30; i++) {
         opened_trace->sens_sort [ j + 8*jamp ] = i;
         j++;
         if (j>=3) {
           j=0;
           jamp ++;
...
set_sens_sort_coross_325(T_OPENED_TRACE * opened_trace) {
  ...
  long tmp_sens_sort[2048];
   ...
   for (i=0; i<12; i++) {
      for (j=0; j<8; j++) {
         ...
         tmp_sens_sort[0] = opened_trace->sens_sort[ (i*16) + j ];

         opened_trace->sens_sort[ (i*16) + j ] = opened_trace->sens_sort[ (i*16) + (15 - j) ];

         opened_trace->sens_sort[ (i*16) + (15 - j) ] = tmp_sens_sort[0];

       };
    };

   // разворачиваем все датчики
   for (i=0; i<96; i++) {

         tmp_sens_sort[0] = opened_trace->sens_sort[i];

         opened_trace->sens_sort[i] = opened_trace->sens_sort[191 - i];

         opened_trace->sens_sort[191 - i] = tmp_sens_sort[0];
...
set_sens_sort_samopisets(T_OPENED_TRACE * opened_trace)
{
     ...
     opened_trace->sens_sort[4 ]=4 ; 
     opened_trace->sens_sort[5 ]=5 ; 
     opened_trace->sens_sort[6 ]=6 ; 
     opened_trace->sens_sort[7 ]=7 ; 
     opened_trace->sens_sort[8 ]=8 ; 
     opened_trace->sens_sort[9 ]=9 ; 
     opened_trace->sens_sort[10]=20;
     opened_trace->sens_sort[11]=21;
     opened_trace->sens_sort[12]=22;
     opened_trace->sens_sort[13]=23;
     opened_trace->sens_sort[14]=35;
     opened_trace->sens_sort[15]=36;
     opened_trace->sens_sort[16]=37;
     opened_trace->sens_sort[17]=38;
     opened_trace->sens_sort[18]=39;
     opened_trace->sens_sort[19]=40;
     opened_trace->sens_sort[20]=41;
     opened_trace->sens_sort[21]=24;
     opened_trace->sens_sort[22]=25;
     opened_trace->sens_sort[23]=26;
     opened_trace->sens_sort[24]=27;
     opened_trace->sens_sort[25]=28;
     opened_trace->sens_sort[26]=29;
     opened_trace->sens_sort[27]=30;
     opened_trace->sens_sort[28]=31;
     opened_trace->sens_sort[29]=32;
     opened_trace->sens_sort[30]=33;
     opened_trace->sens_sort[31]=34;
     opened_trace->sens_sort[32]=10;
     opened_trace->sens_sort[33]=11;
     opened_trace->sens_sort[34]=12;
     opened_trace->sens_sort[35]=13;
     opened_trace->sens_sort[36]=14;
     opened_trace->sens_sort[37]=15;
     opened_trace->sens_sort[38]=16;
     opened_trace->sens_sort[39]=17;
     opened_trace->sens_sort[40]=18;
     opened_trace->sens_sort[41]=19;
     opened_trace->sens_sort[42]=42;
     opened_trace->sens_sort[43]=43;
     opened_trace->sens_sort[44]=44;
     opened_trace->sens_sort[45]=45;
...
set_sens_sort_strs_325(T_OPENED_TRACE * opened_trace) {

   int i;

   for (i=0; i<48; i++) {
       // ставим 4 сектор на место 2
       opened_trace->sens_sort[ i + 144] = i + 48;

       // ставим 2 сектор на место 3
       opened_trace->sens_sort[ i + 48] = i + 96;

       // ставим 3 сектор на место 4
       opened_trace->sens_sort[ i + 96] = i + 144;


       opened_trace->sens_shift[i] = 180; // смещение назад в измерениях

       opened_trace->sens_shift[i+96] = 180; // смещение назад в измерениях
   ...
   switch (opened_trace->corosion_sens_num) 
    {
     ...
     case (144) : {  // вроде как пятисотка
        ...
        opened_trace->Median_Filter_length = 0;
     ...
     case (288) : {  // вроде как новая пятисотка (500 корозионник)
        ...
        opened_trace->Orientation_OFF = 0;
        opened_trace->Orinteation_Direct_count=1;
        opened_trace->Orientation_shift=198; 
        opened_trace->Orientation_shift_2=0;
...
//        opened_trace->real_number_sensor_in_group[0]=96;
     ...
     case (480) : {  // вроде как 1000 стресс
        if (strcmp(target_name, TARGET_NAME_STRESS1000)==0) {
            // Значится 460
            opened_trace->trace_step = 5;     // шаг опроса 5 мм
            opened_trace->group_num  = 1;     // два пояс
...
//                    };
     ...
     case (384) : {
        ...
        if (strcmp(target_name, TARGET_NAME_CORROS426D)==0 ||
            strcmp(target_name, TARGET_NAME_CORROS426L)==0
           )
        {
           ...
           opened_trace->Orientation_OFF = 0;
           opened_trace->Orinteation_Direct_count=0;
           opened_trace->Orientation_shift=96;
           opened_trace->Orientation_shift_2=69;


           opened_trace->sens_for_thick=50;
           opened_trace->sens_for_thick_count=1;
           ...
           if (GetPrivateProfileString(EPRO_SECTION, Invert_sens_data_KEY, "нет", key_value,
            ...
            {
               if (strcmp( key_value, "нет") == 0) {
                  strcpy( opened_trace->invert_sens_data_text, "0-383");
     ...
     case (80) : { // вроде как профиль 500 или 700
        ...
        if (strcmp(target_name, TARGET_NAME_PROFIL500_2)==0) {
            ...
            set_sens_sort_prof_500_2(opened_trace);
...
/*
            ...
            opened_trace->real_number_sensor_in_group[1]=30;
*/
            set_sens_sort_prof_700_2(opened_trace);
        ...
        if (strcmp(target_name, TARGET_NAME_PROFIL1400)==0 ||
            strcmp(target_name, TARGET_NAME_PROFIL1400D)==0)
         {
           ...
           opened_trace->Orientation_shift_2=38;
...
*/
     ...
     case (672) : {  // вроде как стресс 500
        ...
        if (strcmp(target_name, TARGET_NAME_STRESS500)==0) {
           ...
           opened_trace->Orientation_OFF = 0;
           opened_trace->Orinteation_Direct_count=0;
           opened_trace->Orientation_shift = 44;
           opened_trace->Orientation_shift_2=0;

           opened_trace->sens_for_thick=0;
           opened_trace->sens_for_thick_count=48;
           ...
           if (GetPrivateProfileString(EPRO_SECTION, Invert_sens_data_KEY, "нет", key_value,
            ...
            {
               if (strcmp( key_value, "нет") == 0) {
                  strcpy( opened_trace->invert_sens_data_text,"0-671");
           ...
           if (GetPrivateProfileString(EPRO_SECTION, Delete_sens_data_KEY, "нет", key_value,
                          sizeof(key_value), opened_trace->trc_file_name)!=0)
            {
               if (strcmp( key_value, "нет") == 0) {
                  ...
                  WritePrivateProfileString(EPRO_SECTION, Delete_sens_data_KEY,
                                            "48-63,160-175,272-287,336-343,440-455,552-567,664-671",
                                            opened_trace->trc_file_name
                                           );
           ...
           opened_trace->real_number_sensor_in_group[0]=576;
     ...
     case (576) : {  // вроде как стресс 1200
        ...
        opened_trace->Orientation_OFF = 0;
        opened_trace->Orinteation_Direct_count=0;
        opened_trace->Orientation_shift = 40;
        opened_trace->Orientation_shift_2=0;

        opened_trace->sens_for_thick=0;
        opened_trace->sens_for_thick_count=576;
     ...
     case (256) : {  // вроде как трехсотка или 700 корозионники
        ...
        // значится 700 корозионник
             ...
             opened_trace->Orientation_OFF = 0;
             opened_trace->Orinteation_Direct_count=0;
             opened_trace->Orientation_shift = 70;
             opened_trace->Orientation_shift_2=0;
     ...
     case (528) : {  // вроде как Корозионник 508 (Иран)
        ...
        if (strcmp(target_name, TARGET_NAME_CORROS508)==0) {
           ...
           opened_trace->Orientation_OFF = 0;
           opened_trace->Orinteation_Direct_count=0;
           opened_trace->Orientation_shift=140;
           opened_trace->Orientation_shift_2=-7;
...
//           set_sens_sort_prof_426(opened_trace);
     ...
     case (32) : {  // вроде как профиль 325 или Самописец
        ...
        if (strcmp(target_name, TARGET_NAME_PROFIL325)==0) {
           ...
           opened_trace->Orinteation_Direct_count=0;
           opened_trace->Orientation_shift=5;
           opened_trace->Orientation_shift_2=4;
           ...
           opened_trace->real_number_sensor_in_group[0]=18;
           opened_trace->real_number_sensor_in_group[1]=18;
           // Выставили удаление для нужных датчиков
           ...
           set_sens_sort_prof_325(opened_trace);
...
//                };
     ...
     case (64) : {  // вроде как Самописец
        ...
        opened_trace->group_num  = 2;      // 3 пояса

        opened_trace->real_number_sensor_in_group[0]=
        opened_trace->linesense_size[0] = 24;


        opened_trace->real_number_sensor_in_group[1]=
        opened_trace->linesense_size[1] = 40;


        opened_trace->real_number_sensor_in_group[2]=
        opened_trace->linesense_size[2] = 0;

        opened_trace->real_number_sensor_in_group[3]=
        opened_trace->linesense_size[3] = 0;
        ...
        opened_trace->Orientation_OFF = 1;
        opened_trace->Orinteation_Direct_count=0;
        opened_trace->Orientation_shift=4;
        opened_trace->Orientation_shift_2=2;
        ...
        if (GetPrivateProfileString(EPRO_SECTION, Invert_sens_data_KEY, "нет", key_value,
         ...
         {
            if (strcmp( key_value, "нет") == 0) {
               strcpy( opened_trace->invert_sens_data_text, "0-63");
        ...
        opened_trace->real_number_sensor_in_group[0]=20;
        opened_trace->real_number_sensor_in_group[1]=12;
        opened_trace->real_number_sensor_in_group[2]=0;
        opened_trace->real_number_sensor_in_group[3]=0;
        // Выставили удаление для нужных датчиков
        ...
        set_sens_sort_samopisets(opened_trace);
     ...
     case (960) : {  // вроде как СТРЕСС 1400
        ...
        if (strcmp(target_name, TARGET_NAME_STRESS1400)==0) {
           ...
           opened_trace->Orientation_OFF = 0;
           opened_trace->Orinteation_Direct_count=0;
           opened_trace->Orientation_shift=-55;
           opened_trace->Orientation_shift_2=0;
...
//                   };
     ...
     case (192) : {  // вроде как КОРОЗИОННИК 325

        if (strcmp(target_name, TARGET_NAME_CORROS325)==0) {
           // корозионник 1400
           opened_trace->trace_step = 5;     // шаг опроса 5 мм
           opened_trace->group_num  = 1;     // 2 пояса

           opened_trace->real_number_sensor_in_group[0]=
           opened_trace->linesense_size[0] = opened_trace->corosion_sens_num;
           ...
           opened_trace->Orientation_OFF = 0;
           opened_trace->Orinteation_Direct_count=0;
           opened_trace->Orientation_shift=-20;
           ...
           i = MessageBox(NULL, "Это Коррозионник или Стресс-корозионник? \n Коррозионник = Да; Стресс-корозионник = Нет     ", "325 reg",MB_YESNO | MB_ICONQUESTION | MB_SYSTEMMODAL);
           if (i==6) {
//             set_sens_sort_coross_325(opened_trace);
              opened_trace->Orientation_shift=72;
           } else {
              set_sens_sort_strs_325(opened_trace);
              opened_trace->Orientation_shift=115;
           };
...
long WINAPI write_data_to_trc(T_OPENED_TRACE * opened_trace)
{
   ...
   // запишем в trc-файл смещение навигационных данных относительно корозионных
   sprintf(key_name, "%s", ShiftNavigation_data_KEY);
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "нет", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
    {
      ...
      // но его там нет
       if (strcmp( key_value, "нет") == 0) {
          sprintf(key_value, "%i", 0);
       };
    }; 
   WritePrivateProfileString(EPRO_SECTION, key_name, key_value, opened_trace->trc_file_name);
   // записали в trc-файл смещение навигационных данных относительно корозионных
   ...
   // запишем в trc-файл нижнюю границу сигнала для удаления
   sprintf(key_name, "%s", lo_border_KEY);
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
    {
      // на всякий случай перечитали значение,
   ...
   WritePrivateProfileString(EPRO_SECTION, key_name, key_value,
                            opened_trace->trc_file_name);
   // записали в trc-файл нижнюю границу сигнала для удаления
   ...
   // запишем в trc-файл коэффициент ориентации
   sprintf(key_name, "%s", ORIENTATION_dAz_KEY);
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
    {
      // на всякий случай перечитали значение,
   ...
   WritePrivateProfileString(EPRO_SECTION, key_name, key_value, opened_trace->trc_file_name);
   // записали в trc-файл  коэффициент ориентации


   // запишем в trc-файл коэффициент ориентации
   sprintf(key_name, "%s", ORIENTATION_KAz_KEY);
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
    {
      // на всякий случай перечитали значение,
   ...
   // запишем в trc-файл коэффициент ориентации
   sprintf(key_name, "%s", ORIENTATION_dAy_KEY);
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
    {
      // на всякий случай перечитали значение,
   ...
   // запишем в trc-файл коэффициент ориентации
   sprintf(key_name, "%s", ORIENTATION_KAy_KEY);
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
    {
      // на всякий случай перечитали значение,
   ...
   // запишем в trc-файл длинну окна сглаживания для медианного фильтра
   sprintf(key_name, "%s", Median_Filter_length_KEY);
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
    {
      // на всякий случай перечитали значение,
      // если оно изменилось перед повторной регистрацией,
      // но его там нет
      sprintf(key_value, "%d", opened_trace->Median_Filter_length);
    };
   WritePrivateProfileString(EPRO_SECTION, key_name, key_value,
                             opened_trace->trc_file_name);
   // записали в trc-файл длинну окна сглаживания для медианного фильтра
...
long WINAPI read_data_from_trc(T_OPENED_TRACE * opened_trace)
{
   ...
   // читаем из trc-файла смещение навигационных данных относительно корозионных
   sprintf(key_name, "%s", ShiftNavigation_data_KEY);
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "нет", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
   {
       opened_trace->ShiftNavigation_data = 0;
   }; 
   opened_trace->ShiftNavigation_data = atoi(key_value);
   // прочитали из trc-файла смещение навигационных данных относительно корозионных
   ...
   // читаем из trc-файла шаг одометра
   sprintf(key_name, "%s", lo_border_KEY);
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "0", key_value,
                               sizeof(key_value), opened_trace->trc_file_name) == 0)
    {
      strcpy(key_value, "0");
    };
   opened_trace->lo_border = atoi(key_value);
   // прочитали из trc-файла шаг одометра
   ...
   // читаем из trc-файла коэффициент ориентации
   sprintf(key_name, "%s", ORIENTATION_dAz_KEY);
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
    {
      sprintf (drvError, "Ошибка чтения коеффициент ориентации %s.", opened_trace->trc_file_name);
      opened_trace->dAz = 1;
    } else {
      opened_trace->dAz = atof(key_value);
    };
   //  прочитали из trc-файла  коэффициент ориентации
   ...
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
    {
      ...
      opened_trace->KAz = atof(key_value);
    };
   //  прочитали из trc-файла  коэффициент ориентации
   ...
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
    {
      ...
      opened_trace->dAy = atof(key_value);
    };
   //  прочитали из trc-файла  коэффициент ориентации
   ...
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "", key_value,
                  sizeof(key_value), opened_trace->trc_file_name)==0)
    {
      ...
      opened_trace->KAy = atof(key_value);
    };
   //  прочитали из trc-файла  коэффициент ориентации
   ...
   // читаем из trc-файла длинну окна сглаживания для медианного фильтра
   sprintf(key_name, "%s", Median_Filter_length_KEY);
   if (GetPrivateProfileString(EPRO_SECTION, key_name, "", key_value,
                               sizeof(key_value), opened_trace->trc_file_name) == 0)
   {
      ...
      opened_trace->Median_Filter_length = atoi(key_value);
   };
   // прочитали из trc-файла длинну окна сглаживания для медианного фильтра
...
T_OPENED_TRACE * WINAPI init_opened_trace() {
  ...
  space_for_trace->Median_Filter_length = 0;
  ...
  space_for_trace->index_bypass.file_data=NULL;
...
T_OPENED_TRACE * WINAPI free_opened_trace( T_OPENED_TRACE *p_free) {
  ...
  if (p_free != NULL) {
      ...
      if (p_free->index_bypass.file_data!=NULL) {
         fclose(p_free->index_bypass.file_data);
...
//--------------------------------------------------------------------
  ...
  // откроем и смапируем файл с данными байпаса
   new_trace->index_bypass.file_data = fopen(new_trace->index_bypass.file_name, "rb");
...
//  new_trace->corosion_sens_num = file_header.cor_num;
  new_trace->frequency_processor = file_header.proc_frequency;
...
long Init_NavData(T_NAVIGATION_DATA *NavData, char * trc)
{
  ...
  if (GetPrivateProfileString(DRIVER_DATA , NAVIGATION_FILE_KEY, "",
   ...
   { // Ну, путь на данные прописан
     // попробуем открыть файл
     if ( (NavData->file_data=
           fopen(NavData->file_name, "rb")
          )!=NULL) 
      { // файл присутствует
...
long Init_VogData(T_VOG_DATA *VogData, char * trc)
{
  ...
  VogData->file_data=NULL;
    // читаем из ini-файла путь на файл с навигациоддыми данными
  if (GetPrivateProfileString(DRIVER_DATA , VOG_FILE_KEY, "",
   ...
   { // Ну, путь на данные прописан
     // попробуем открыть файл
     if ( (VogData->file_data=
           fopen(VogData->file_name, "rb")
          )!=NULL) 
      { // файл присутствует
        // посчитаем его длинну (в записях навигации)
...
long Init_navigete(T_TRACE_LIST * p_trace_list, T_TRACEINFO *inf){
   ...
   if (Init_NavData(&p_trace_list->NavData, p_trace_list->trace->trc_file_name)
       ==KRT_ERR) 
    {
   ...
   if (Init_VogData(&p_trace_list->VogData, p_trace_list->trace->trc_file_name)
       ==KRT_ERR) 
    {
       strcat (drvError, "(Init_navigete)");
       return KRT_ERR;
