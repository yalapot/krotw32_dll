...
#define Delete_sens_string  "112-127, 240-255, 368-383, 496-511"
#define Deleted_sens_num    64
...
void create_sens_sort ( long *sens_sort)
{
   ...
   for (i=0; i<128; i++) {
      sens_sort[128 * 0 + i] = 128 * 0 + i;
      sens_sort[128 * 1 + i] = 128 * 3 + i;
      sens_sort[128 * 2 + i] = 128 * 1 + i;
      sens_sort[128 * 3 + i] = 128 * 2 + i;
   };
...
//      sens_shift[i+384] = 256;
//   };

   // смещение вo 1 и 3 секторах
   for (i=0; i<128; i++) {
      sens_shift[i+  0] = 256;
      sens_shift[i+256] = 256;
   };
...
long check_file_ID(char* target_name)
{
      ...
      if (strncmp(target_name, "72100101", 8)==0)
      {
          ...
          Orientation_shift_group_1 = -57;
          Orientation_shift_group_2 = 0;

          Odometer_0_sens_value = 343;
          Odometer_1_sens_value = 110;
