...
void create_sens_shift ( long *sens_shift)
{
   ...
   // md22
   // смещение вo 2 и 4 секторах для 896 датчиков
//   for (i=0; i<224; i++) {
//      sens_shift[i + 224] = 1118;
//      sens_shift[i + 672] = 1118;
//   };

   // смещение вo 2 и 4 секторах для 224 датчиков
//   for (i=0; i<56; i++) {
//      sens_shift[i + 56] = 1118;
//      sens_shift[i + 168] = 1118;
//   };

//   // смещение ласт по 8 датчиков для 896 датчиков
//   for (last_count = 0; last_count < MAGN_SENSORS; last_count += 16) {
//        for (i=0; i<8; i++) {
//            sens_shift[last_count + 8 + i] += 60;
//        };
//   };

   // смещение ласт по 2 датчиков для 224 датчиков
