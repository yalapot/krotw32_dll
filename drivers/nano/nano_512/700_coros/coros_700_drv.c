...
long check_file_ID(char* target_name)
{
      ...
      if  ( strncmp(target_name, "72010101", 8)==0 )
      {
          ...
          Orientation_shift_group_1 =  114;
          Orientation_shift_group_2 =   21;
