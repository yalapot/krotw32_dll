...
#define Delete_sens_string  "64-95,128-191,256-287,320-383,448-479,512-575"
#define Deleted_sens_num    288
...
long check_file_ID(char* target_name)
{
      ...
      if  ( strncmp(target_name, "53000103", 8)==0 )
      {
          ...
          Odometer_0_sens_value = 192;
          Odometer_1_sens_value = 436;
