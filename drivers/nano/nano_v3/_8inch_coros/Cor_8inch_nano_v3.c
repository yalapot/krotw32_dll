...
#define Orient_dAy_value      510.506
#define Orient_KAy_value      239.417
#define Orient_dAz_value      490.436
#define Orient_KAz_value      241.810

#define Orientation_shift_value    -24
