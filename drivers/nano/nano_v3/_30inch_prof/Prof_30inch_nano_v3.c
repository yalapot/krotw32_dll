...
#define Orient_dAy_value     481.10
#define Orient_KAy_value    -235.90
#define Orient_dAz_value     494.65
#define Orient_KAz_value     236.65

#define Orientation_shift_value     -5
...
#define LENGTH_SENS         (162.0)  // в мм длинна энкодерного датчика (ось энкодера ось полиуританового колеса)
...
//    translate_res = (translate_res * 80 / 240 - 330) /2 + 50;
