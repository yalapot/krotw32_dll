...
int Orientation_shift_value   = 16;
...
#define Invert_sens_string  "0-224"
...
void create_sens_sort ( long *sens_sort)
{
   ...
   for(i = 0; i < 48; i++)
   {
       sens_sort[ 48 + i] = tmp_sens_sort[112 + i];
       sens_sort[112 + i] = tmp_sens_sort[ 48 + i];
   }
...
long check_file_ID(char* target_name)
{
      ...
      MessageBox(NULL, "Выберете другой драйвер! \nЭто драйвер стресс 426 id 32050103 (Nano v3)","Драйвер Стресс-коррозионник 426 (Nano v3)", MB_OK | MB_ICONQUESTION | MB_SYSTEMMODAL);
      return KRT_ERR;
}
