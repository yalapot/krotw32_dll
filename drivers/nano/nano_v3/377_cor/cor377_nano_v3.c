...
int Orientation_shift_value   =  35;
...
#define Invert_sens_string  "0-244"
#define Zerro_sens_string   ""

#define ADD_THEN_CAHANGE_ODOM 0

long num_sens_for_thick = 144;
...
long check_file_ID(char* target_name)
{
      ...
      if  ( strncmp(target_name, "32150103", 8)==0 )
      {
         ...
         Orient_dAy_value =     547.988;
         Orient_KAy_value =     243.385;
         Orient_dAz_value =     507.404;
         Orient_KAz_value =     246.388;

         Orientation_shift_direct = 1; 
                                       
         Orientation_shift_value   = 39;
         Orientation_shift_2_value = 0;
