...
int Orientation_shift_value   =  34;
int Orientation_shift_2_value = -22;
...
#define Invert_sens_string  "0-191, 192-255"
...
long check_file_ID(char* target_name)
{
      ...
      if  ( strncmp(target_name, "32150104", 8)==0 )
      {
         // это калибровка для ID 3205010340
         Orient_dAy_value =     490.503;
         Orient_KAy_value =     222.981;
         Orient_dAz_value =     501.043;
         Orient_KAz_value =     223.335;


         Orientation_shift_direct = 1;

         Orientation_shift_value   =  160;
         Orientation_shift_2_value =   22;
