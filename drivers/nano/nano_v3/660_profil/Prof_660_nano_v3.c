...
#define Orient_dAy_value      496.927
#define Orient_KAy_value      242.402
#define Orient_dAz_value      505.207
#define Orient_KAz_value      242.611

#define Orientation_shift_value     3
