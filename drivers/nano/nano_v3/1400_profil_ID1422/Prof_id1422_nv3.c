...
#define LENGTH_SENS         (284.0)  // в мм длинна энкодерного датчика (ось энкодера ось полиуританового колеса)
#define ZERO_ANGLE_GRADUS   (63)   // в градусах угол между осью снаряда и рычагом датчика в крайнем верхнем положении
...
long check_file_ID(char* target_name)
{
      ...
      MessageBox(NULL, "Выберете другой драйвер! \nЭто драйвер Профиль 1400 (Nano v1)","Драйвер Профиль 1400 с энкодерными датчиками (Nano v3)", MB_OK | MB_ICONQUESTION | MB_SYSTEMMODAL);
      return KRT_ERR;
}
