...
#define Orient_dAy_value      589.145
#define Orient_KAy_value      236.935
#define Orient_dAz_value      566.348
#define Orient_KAz_value      230.428
...
#define Invert_sens_string  "14-17,23,27,30-31"
...
long Odometer_0_sens_value = 28;
long Odometer_1_sens_value = 13;
...
long check_file_ID(char* target_name)
{
      ...
      if  ( strncmp(target_name, "10230102", 8)==0 )
      {
         return KRT_OK;
      }

      MessageBox(NULL, "Выберете другой драйвер! \nЭто драйвер Профиль 1000 (Nano v1)","Драйвер Профиль 1000 (Nano v1)", MB_OK | MB_ICONQUESTION | MB_SYSTEMMODAL);
      return KRT_ERR;
