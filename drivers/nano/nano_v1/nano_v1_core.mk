...
$(DRV_LIST): $(NANO_V1_CORE) $(KROT_API)
...
$(TARGET_VERSION): $(DRV_DEF) $(DRV_LIST) $(FILE_BUFEERING_LIB)
	$(LINK) /DLL /DEF:$(DRV_DEF) /OUT:$(TARGET_VERSION) $(DRV_LIST) $(WIN_LIB) $(FILE_BUFEERING_LIB) $(HEIGHT_ARROW) $(BENDING_PLANE)
