...
#define PROFIL_MATH_INVERSE "достаточно объявить и инвертируется сигнал на II втором поясе профиля"
...
#define Delete_sens_string  "8-15,24-32,41-48,57-63"
...
long check_file_ID(char* target_name)
{
      ...
      if  ( strncmp(target_name, "1221010222", 10)==0 )
      {
         Odometer_0_sens_value = 1;
         Odometer_1_sens_value = 16;
