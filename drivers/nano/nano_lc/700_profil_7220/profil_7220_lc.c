...
#define LENGTH_SENS         (132)  // в мм длинна энкодерного датчика (ось энкодера ось полиуританового колеса)
...
long check_file_ID(char* target_name)
{
      ...
      MessageBox(NULL, "Выберете другой драйвер! \nЭто драйвер Профиль 700 (Nano lc) id 7220",
                       "Драйвер Профиль 700 с энкодерными датчиками (Nano lc)", MB_OK | MB_ICONQUESTION | MB_SYSTEMMODAL);
      return KRT_ERR;
}
