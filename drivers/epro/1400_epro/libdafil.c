...
*/
           ...
           if (corros_num == 288) { //coros 500
              //                                          dAz         KAz
              sA=((double)(unarc_data->inquiry[i].accel_x-619.387)) / 263.849;
              //                                          dAy         KAy
              cA=((double)(unarc_data->inquiry[i].accel_y-572.477)) / 269.605;
           ...
           if (corros_num == 528) { //Корозионник 508 (Иран)
              if (strcmp(target_name, TARGET_NAME_CORROS508)==0) {
                   ...
                   //                                          dAz         KAz
                   cA=((double)(unarc_data->inquiry[i].accel_y-503.413)) / (-238.14);
                   //                                          dAy         KAy
                   sA=((double)(unarc_data->inquiry[i].accel_x-534.308)) / (-242.59);
                   unarc_data->inquiry[i].orient =
                        calkulate_orientation(cA, sA, opened_trace->real_number_sensor_in_group[0]);
               } else {
                  // значит ...
