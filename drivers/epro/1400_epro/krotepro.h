...
#define TARGET_NAME_STRESS500  "STRESS500      "
...
#define TARGET_NAME_CORROS426  "COROS_426+SIT"
...
//   HANDLE file_data;             /* дескриптор открытого файла данных      */
   HANDLE hFileMap;
   char *map_area_mem;
} T_INDEX_EXTEND_SENS;
...
typedef struct {  // описание открытой трассы
   ...
   long  view_len;           // длинна трассы необходимая для просмотра в отсчетах одометра
