...
// дополнительных датчиков через функцию krtDrvGetFirstNodeGroup
  ...
  TNodeGroup = Record
    ...
    thickVal: Integer;      // значение канала толщины стенки трубы
    thickPos: Integer;      // положение на трассе показаний канала толщины стенки трубы

    VOGX: Integer;         // координаты X,Y,Z
    VOGY: Integer;
    VOGZ: Integer;
    AccelX: Single;  //  VogData.cur_data.Psi;
    AccelY: Single;  //  VogData.cur_data.Teta; 
    AccelZ: Single;  //  VogData.cur_data.Gamma;
