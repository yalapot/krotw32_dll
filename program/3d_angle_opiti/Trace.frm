...
Dim radiusXY As Long, angleXY As Single, angle3D As Single, radius3D As Long
...
If vog.turnInfo(Start, length, 0, radiusXY, angleXY, radiusZ, angleZ, markX, markY, markZ, angle3D, radius3D, user_length) Then
