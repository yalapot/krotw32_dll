...
//декодирование(деоптимизация)
void DeOptimize(unsigned char *src,unsigned char *dest,unsigned long sensors,unsigned long samples)
{
	unsigned long i,j;
	//декодируем мл.части
	for(i=0;i<sensors;i++)
