...
extern size_t qlz_size_decompressed(const char *source);
extern size_t qlz_size_compressed(const char *source);
extern size_t qlz_decompress(const char *source, void *destination, char *scratch_decompress);
extern size_t qlz_compress(const void *source, char *destination, size_t size, char *scratch_compress);
extern int qlz_get_setting(int setting);
extern void delta_decode(char *buffer, int length);
extern void DeOptimize(unsigned char *src,unsigned char *dest,unsigned long sensors,unsigned long samples);
